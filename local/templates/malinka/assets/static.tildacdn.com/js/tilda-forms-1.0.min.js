    ...
    F.mask = {
        ...
        mask: function(e, y) {
            ...
            return y = F.extend({
                ...
                function f(t, e) {
                    for (var r = t; r < e && r < $; r++) g[r] && (s[r] = c(r))
                }
                ...
                function h(t) {
                    for (var e, r = n.val(), a = -1, o = 0, i = 0; o < $; o++)
                        if (g[o]) {
                            for (s[o] = c(o); i++ < r.length;)
                                if (e = r.charAt(i - 1), g[o].test(e)) {
                                    s[o] = e, a = o;
                                    break
                                } if (i > r.length) {
                                f(o + 1, $);
                        ...
                        } else s[o] === r.charAt(i) && i++, o < v && (a = o);
                    return t ? w() : a + 1 < v ? y.autoclear || s.join("") === d ? (n.val() && n.val(""), f(0, $)) : w() : (w(), n.val(n.val().substring(0, a + 1))), v ? o : j
                }
                n.data(F.mask.dataName, function() {
                    ...
                    var e, r, a, o;
                    n.prop("readonly") || (e = t.which || t.keyCode, x = n.val(), 8 === e || 46 === e || k && 127 === e ? (a = (r = n.caret()).begin, (o = r.end) - a == 0 && (a = 46 !== e ? function(t) {
                        for (; 0 <= --t && !g[t];);
                        return t
                    }(a) : o = m(a - 1), o = 46 === e ? m(o) : o), f(a, o), u(a, o - 1), t.preventDefault()) : 13 === e ? p.call(this, t) : 27 === e && (n.val(i), n.caret(0, h()), t.preventDefault()))
                }).on("keypress.mask", function(t) {
                    var e, r, a, o, i;
                    n.prop("readonly") || (e = t.which || t.keyCode, r = n.caret(), t.ctrlKey || t.altKey || t.metaKey || e < 32 || e && 13 !== e && (r.end - r.begin != 0 && (f(r.begin, r.end), u(r.begin, r.end - 1)), (a = m(r.begin - 1)) < $ && (i = String.fromCharCode(e), g[a].test(i) && (function(t) {
                        for (var e, r, a = t, o = c(t); a < $; a++)
                            if (g[a]) {
                                if (e = m(a), r = s[a], s[a] = o, !(e < $ && g[e].test(r))) break;
                                o = r
                            }
                    }(a), s[a] = i, w(), o = m(a), _ ? setTimeout(function() {
                        F.proxy(F.fn.caret, n, o)()
                    }, 0) : n.caret(o), r.begin <= b && l())), t.preventDefault()))
...
function($) {
    window.tildaBrowserLang = window.navigator.userLanguage || window.navigator.language, window.tildaBrowserLang = window.tildaBrowserLang.toUpperCase(), -1 != window.tildaBrowserLang.indexOf("RU") ? window.tildaBrowserLang = "RU" : window.tildaBrowserLang = "EN", window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.tildaForm = {
        ...
        window.tildaForm.captchaCallback = function(t) {
            ...
            }), "y" === t.attr("data-formcart") && (e = void 0 !== window.tcart_minorder && 0 < window.tcart_minorder, r = void 0 !== window.tcart_mincntorder && 0 < window.tcart_mincntorder, e && (window.tcart.prodamount >= window.tcart_minorder || ((a = {}).obj = $({}), a.type = [], a.type.push("minorder"), l.push(a))), r && (window.tcart.total >= window.tcart_mincntorder || ((a = {}).obj = $({}), a.type = [], a.type.push("minquantity"), l.push(a)))), c && 0 == l.length && (l = [{
                obj: "none",
                type: ["emptyfill"]
            }]), l
            ...
            var r, a, o, i = (i = t.data("inputbox")) || ".blockinput",
                n = window.tildaForm.arValidateErrors[window.tildaBrowserLang] || {},
                s = "",
                d = "",
            ...
            for (var r, a, o, i = (i = t.data("inputbox")) || ".blockinput", n = window.tildaForm.arValidateErrors[window.tildaBrowserLang] || {}, s = "", d = 0; d < e.length; d++)
                if (e[d] && e[d].obj) {
                    if (0 == d && "none" == e[d].obj) {
                        (o = t.find(".js-rule-error-all")).html(n.emptyfill), o.css("display", "block").show();
                        break
                    }
                    for ((a = 0) < (r = e[d].obj.closest(i).addClass("js-error-control-box")).find(".t-input-error").length && (a = 1), j = 0; j < e[d].type.length; j++) error = e[d].type[j], s = "", (o = t.find(".js-rule-error-" + error)).attr("data-rule-filled") ? o.css("display", "block").show() : 0 < o.length ? ("" == o.text() && "" < n[error] ? o.html(n[error]) : s = o.eq(0).text(), o.css("display", "block").show()) : "" < n[error] && (o = t.find(".js-rule-error-all")) && 0 < o.length && (o.html(n[error]), o.css("display", "block").show()), a && ("" == s && ("" < n[error + "field"] ? s = n[error + "field"] : "" < n[error] && (s = n[error])), "" < s && r.find(".t-input-error").html(s))
            ...
            try {
                ["city", "street", "pickup-name", "pickup-address", "pickup-id", "house", "entrance", "floor", "aptoffice", "phone", "entrancecode", "comment", "service-id", "hash", "postalcode", "country", "userinitials", "onelineaddress"].forEach(function(t) {
            ...
            var r;
            window.scriptSysPayment || (window.scriptSysPayment = {}), window.scriptSysPayment[e] && !0 === window.scriptSysPayment[e] || ((r = document.createElement("script")).type = "text/javascript", r.src = t, document.body.appendChild(r), window.scriptSysPayment[e] = !0)
            ...
            var r = "/tilda/" + t.attr("id") + "/payment/",
                ...
                o = e.amount,
                i = e.description;
            window.Tilda && "function" == typeof Tilda.sendEventToStatistics && ($("#allrecords").data("tilda-currency") || $(".t706").data("project-currency-code") || $("#allrecords").data("tilda-currency", e.currency), Tilda.sendEventToStatistics(r, a, i, o)), "" < e.successurl && window.setTimeout(function() {
            ...
            var t;
            !0 !== window.stripeapiiscalled && ((t = document.createElement("script")).type = "text/javascript", t.src = "https://checkout.stripe.com/checkout.js", document.body.appendChild(t), window.stripeapiiscalled = !0)
                    ...
                    t && t.id && $.ajax({
                        ...
                        success: function(t) {
                            ...
                            var e = "/tilda/" + n.attr("id") + "/payment/",
                                ...
                                a = s.amount,
                                o = s.description;
                            window.Tilda && "function" == typeof Tilda.sendEventToStatistics && ($("#allrecords").data("tilda-currency") || $(".t706").data("project-currency-code") || $("#allrecords").data("tilda-currency", s.currency), Tilda.sendEventToStatistics(e, r, o, a)), "" < s.successurl && window.setTimeout(function() {
            ...
            var t;
            !0 !== window.cloudpaymentsapiiscalled && ((t = document.createElement("script")).type = "text/javascript", t.src = "https://widget.cloudpayments.ru/bundles/cloudpayments", document.body.appendChild(t), window.cloudpaymentsapiiscalled = !0)
            ...
            var d = s.currency,
                t = {},
                e = (e = s.language) || ("RUB" == d || "BYR" == d || "BYN" == d || "RUR" == d ? "ru-RU" : "UAH" == d ? "uk" : "en-US");
            if (!window.cloudpaymentshandler) {
                ...
                t = {
                    language: e
                }, s.applePaySupport && "off" == s.applePaySupport && (t.applePaySupport = !1), s.googlePaySupport && "off" == s.googlePaySupport && (t.googlePaySupport = !1), window.cloudpaymentshandler = new cp.CloudPayments(t)
            }
            var r = {};
            ...
            var virtPage, virtTitle, virtPrice, virtProduct, currency, arMessage;
            ...
            (!r || "fast" != r.condition) && r && "" < r.html ? ($("#allrecords").append(r.html), $(".t-banktransfer .t-popup__close").off("click"), $(".t-banktransfer .t-popup__close").click(function() {
                ...
                return !1
            }), $("body").addClass("t-body_popupshowed"), 0 < (a = $("#formbanktransfer")).length && (a.off("submit"), a.find(".t-submit").off("click"), a.find(".t-submit").off("dblclick"), a.submit(function(t) {
                if (t.preventDefault(), (o = window.tildaForm.validate(a)) && 0 < o.length) return window.tildaForm.showErrors(a, o), !1;
                $.ajax({
                    type: "POST",
                    ...
                    success: function(t) {
                        if ($("body").removeClass("t-body_popupshowed"), a.closest(".t-banktransfer").remove(), (t = t || {
            ...
            var t, e = $("body");
            e.hasClass("t-body_scroll-locked") || (t = void 0 !== window.pageYOffset ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop, e.addClass("t-body_scroll-locked"), e.css("top", "-" + t + "px"), e.attr("data-popup-scrolltop", t))
        }, window.tildaForm.unlockBodyScroll = function() {
            var t, e = $("body");
            e.hasClass("t-body_scroll-locked") && (t = $("body").attr("data-popup-scrolltop"), e.removeClass("t-body_scroll-locked"), e.css("top", ""), e.removeAttr("data-popup-scrolltop"), window.scrollTo(0, t))
        ...
        0 < $jallforms.length && $jallforms.each(function() {
            ...
            if (0 < a.find(".g-recaptcha").length && grecaptcha) {
                ...
                var d, l = a.data("tilda-captcha-clientid");
                return void 0 === l || "" === l ? (d = {
                    size: "invisible",
                    sitekey: a.data("tilda-captchakey"),
                    callback: window.tildaForm.captchaCallback
                }, l = grecaptcha.render(a.attr("id") + "recaptcha", d), a.data("tilda-captcha-clientid", l)) : grecaptcha.reset(l), grecaptcha.execute(l), !1
            }
